package com.shui.imoocexpandablelistview.bean;
...
public class ChapterLab {
    public static List<Chapter> generateMockDatas() {
        ...
        Chapter root3 = new Chapter(1, "Unity_3D");
        Chapter root4 = new Chapter(1, "Cocos2d-x");

        root1.addChild(1, "PullToRefresh");
        root1.addChild(2, "Android 8.0 通知栏解决方案");
        root1.addChild(4, "Android与WebView的js交互");
        root1.addChild(8, "Android UniAutomator 2.0入门实战");
        root1.addChild(10, "移动端音视频入门");

        root2.addChild(11, "iOS开发之LeanCloud");
        root2.addChild(12, "iOS开发之传感器");
        root2.addChild(13, "iOS开发之网络协议");
        root2.addChild(14, "iOS开发之分享集成");
        root2.addChild(15, "iOS开发之FTP上传");

        root3.addChild(16, "Unity 3D 翻牌游戏开发");
        root3.addChild(17, "Unity 3D 基础之变体Transform");
        root3.addChild(20, "带你开发类似Pokeman Go的AR游戏");
        root3.addChild(21, "Unity 3D 游戏开发之脚本系统");
        root3.addChild(22, "Unity 3D 地形编辑器");
